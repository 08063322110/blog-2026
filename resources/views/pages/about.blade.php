...
@section('content')
    ...
    <div style="margin-top: -25px" class="site-cover site-cover-sm same-height overlay single-page" style="margin-top: -25px; background-image: url('{{asset('assets/images/hero_5.jpg') }}');">
		<div class="container">
	...
	<div class="section">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-4 mb-4 text-center" data-aos="fade-up" data-aos-delay="200">
					<img src="{{asset('assets/images/person_6.jpg') }}" alt="Image" class="img-fluid w-50 rounded-circle mb-3">
		...
		<div class="container">
			<div class="row justify-content-between">
				<div class="col-lg-7 mb-4 mb-lg-0">
					...
					<img src="	{{asset('assets/images/img_7_sq.jpg') }}">
				</div>
